...
def generate_launch_description():
    ...
    ground_segment = ComposableNode(
        ...
        parameters=[
               {'cloud_topic': "/gamma1/sensing/lidar/concatenated/pointcloud"}, # Input pointcloud
                {'frame_id': "gamma1/TMF"},
                {'sensor_height': 1.7},
                ...
                {'th_seeds_v': 0.8},        # threshold for lowest point representatives using in initial seeds selection of vertical structural points.
                {'th_dist_v': 0.9},          # threshold for thickenss of vertical structure.
                {'max_r': 80.0},             # max_range of ground estimation area
                {'min_r': 0.0},              # min_range of ground estimation area
                {"RNR_ver_angle_thr": -46.0},
                {"adaptive_seed_selection_margin":-1.6},
    ...
    euclidean_grid= ComposableNode(
            ...
            plugin='lidar_cluster::EuclideanGrid',
            parameters=[
                ...
                {'voxel_leaf_size': 1.0},
                {'minX': 2.0},
                {'min_points_number_per_voxel': 100},
                {'verbose1': False},
                {'verbose2': False},
            ],
