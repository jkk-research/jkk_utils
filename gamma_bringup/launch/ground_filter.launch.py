...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument('cloud_topic', default_value="/lidar_filter_output", description="a pointcloud topic to process",),
        DeclareLaunchArgument('cloud_frame', default_value="gamma1/TMF", description="a pointcloud topic to process",),
