...
def exit_process_function(_launch_context):
    # ~/mcap/mcap info /mnt/bag/2024-04-04_slam/scenario01_lexus3_2024-04-04_17-00/scenario01_lexus3_2024-04-04_17-00_0.mcap 
    print("Recording finished.")
    # tag_ to string
    tag_ = _launch_context.launch_configurations["tag"]
    print("")
    print("ros2 bag info /mnt/bag/" + date_ + "_slam/"+ tag_ +"_lexus3_" + date_and_time_)
    print("~/mcap/mcap info /mnt/bag/" + date_ + "_slam/"+ tag_ +"_lexus3_" + date_and_time_ + "/" + tag_ +"_lexus3_" + date_and_time_ + "_0.mcap")
